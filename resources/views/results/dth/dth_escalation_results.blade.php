...
@section('content')  
  ...
  <div class="card card-info">
    <div class="card-header">
      <h3 class="card-title">DTH Escalation Results</h3>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-2">
    ...
    <!-- /.card-body -->
                ...
                <form class="form-horizontal">
                  ...
                  <a href="#" class="btn btn-infor float-left"  > Edit Call</a>
                    <a href="/quality_analyst/Welcometeamcategory" class="btn btn-infor float-right"  > QA Another Call</a>
                  </div>
                  <!-- /.card-footer -->
                </form>
              </div>
