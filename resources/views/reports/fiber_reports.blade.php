...
<div class="form-group">
   <select class="form-control" required="required" id="section" name="section"><option selected="selected" value="">--Select service--</option><option value="1">Fiber</option></select>
</div>
</div>
