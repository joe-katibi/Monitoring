...
<fieldset>
    <div class="form-group">
        ...
        {{-- Display the select with multiple selected options --}}
        {{ Form::select('category[]', $category->pluck('category_name', 'id'), $selectedCategoryIds, ['class' => 'form-control select2', 'multiple' => true, 'disabled' => 'disabled']) }}
    </div>
</fieldset>
