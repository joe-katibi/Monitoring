...
@section('content')
  <!-- /.card -->
  <form action="{{ route('dthescalation.store') }}" method="POST" name="listForm">
  ...
  <div class="card card-info">
    ...
    <div>
      ...
      <div class="card-footer">
          <button  type="submit" class="btn btn-info float-right" id="submit">Save &
              Finish</button>
