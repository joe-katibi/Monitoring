...
@section('title', 'Team Leader Dashboard | Zuku Monitoring')

@section('content_header')
    <h1 hidden> Team leader Dashboard</h1>
@stop
...
<div class="card card-success">
    <div class="card-header">
        <input readonly class="form-control" style="color: green"  value="Team-leader Dashboard">
    </div>
...
<div class="row">
  <div class="col-lg-3 col-4">
    ...
    <div class="small-box bg-info">
      <div class="inner">
        <h3>{{ $agentAlertTotal }}</h3>

        <p>Total Auto Fails</p>
      </div>
      <div class="icon">
        <i class="ion ion-person"></i>
      </div>
