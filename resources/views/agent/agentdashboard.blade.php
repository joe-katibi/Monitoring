...
@section('title', 'Agent Dashboard | Zuku Monitoring')
...
@section('content')
  ...
  <div class="card card-success">
    <div class="card-header">
        <input readonly class="form-control" style="color: green"  value="Agent Dashboard">
    </div>
     <!-- Main content -->
...
@section('css')
<!-- Include CSS styles for the chart -->
