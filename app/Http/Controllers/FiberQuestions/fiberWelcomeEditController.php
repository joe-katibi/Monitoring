...
class fiberWelcomeEditController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::beginTransaction();
            $updating = FiberWelcomeQuestion::where('id','=',$id);
            ...
            Alert::warning('Update Failled', 'Something Went Wrong');
    ...
    {
        //
        $destroy =DB::table('fiber_welcome_questions')->where('id',$id)->destroy();
