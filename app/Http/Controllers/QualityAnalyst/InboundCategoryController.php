...
class InboundCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/inboundteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('inbound_category')->info('inbound Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('inbound_category')->info('inbound Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('inbound_category')->info('inbound  Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('fiber_inbound_results');
