...
class DthEscalationCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthescalationteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('Dthescalation_category')->info('Dthescalation Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('Dthescalation_category')->info('Dthescalation Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('Dthescalation_category')->info('DthescalationCategory Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_escalation_results');
