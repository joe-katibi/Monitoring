...
class DthServiceSupportCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthservicesupportteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('dthservicesupport_category')->info('dthservicesupport Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('dthservicesupport_category')->info('dthservicesupport Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('dthservicesupport_category')->info('dthservicesupport Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_servicesupport_results');
