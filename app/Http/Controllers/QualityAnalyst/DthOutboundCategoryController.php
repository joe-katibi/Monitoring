...
class DthOutboundCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthoutboundteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('dthoutbound_category')->info('dthoutbound Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('dthoutbound_category')->info('dthoutbound Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('dthoutbound_category')->info('dthoutbound Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_outbound_results');
