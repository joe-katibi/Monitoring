...
class DigitalCategoryController extends Controller
{
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/digitalteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('digital_category')->info('digital Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('digital_category')->info('digital Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('digital_category')->info('digital Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('digital_results');
