...
class ShopsCategoryController extends Controller
{
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/shopsteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('shops_category')->info('Shops Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('shops_category')->info('Shops Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('shops_category')->info('Shops Category Updated : ------> ', ['200' , $results_update->toArray() ] );
