...
use Datatables;
class DthWelcomeCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthwelcometeamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('dthwelcome_category')->info('dthwelcome Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('dthwelcome_category')->info('dthwelcome Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('dthwelcome_category')->info('dthwelcome  Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_welcome_results');
