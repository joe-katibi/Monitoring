...
class DthLiveCallCategoryController extends Controller
{
...

    {
        ...
        return view('quality_analyst/dthlivecallsteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('dthlivecall_category')->info('dthlivecall Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('dthlivecall_category')->info('dthlivecall Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('dthlivecall_category')->info('dthlivecall Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_livecalls_results');
