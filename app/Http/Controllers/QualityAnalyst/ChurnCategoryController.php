...
class ChurnCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        $questions = FiberWelcomeQuestion::where('category', '=', $category)->get();
         ...
         return view('quality_analyst/churnTeamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('churn_category')->info('Churn Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('churn_category')->info('Churn Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('churn_category')->info('Churn Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             print_pre([$results , $totals] , true);
            return redirect('fiber_churn_results');
