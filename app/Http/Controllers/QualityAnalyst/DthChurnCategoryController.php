...
class DthChurnCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthchurnTeamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('DthChurn_category')->info('DthChurn Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('DthChurn_category')->info('DthChurn Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('DthChurn_category')->info('DthChurn Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_churn_results');
