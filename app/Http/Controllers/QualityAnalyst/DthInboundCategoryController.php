...
class DthInboundCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthinboundteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('Dthinbound_category')->info('Dthinbound Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('Dthinbound_category')->info('Dthinbound Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('Dthinbound_category')->info('Dthinbound Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_inbound_results');
