...
class DthDigitalCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthdigitalteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('Dthdigital_category')->info('dthdigital Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('Dthdigital_category')->info('dthdigital Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('Dthdigital_category')->info('dthdigital Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_digital_results');
