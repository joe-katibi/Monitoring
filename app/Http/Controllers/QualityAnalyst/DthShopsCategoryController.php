...
class DthShopsCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/dthshopsteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('dthshops_category')->info('dthshops Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('dthshops_category')->info('dthshops Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('dthshops_category')->info('dthshops  Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('dth_shops_results');
