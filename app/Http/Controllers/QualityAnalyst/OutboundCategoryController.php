...
class OutboundCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/outboundteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('outbound_category')->info('outbound Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('outbound_category')->info('outbound Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('outbound_category')->info('outbound Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('fiber_outbound_results');
