...
class ServiceSupportCategoryController extends Controller
{
    /**
    ...
    public function index($category)
    {
        ...
        return view('quality_analyst/servicesupportteamcategory')->with($data);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            log::channel('servicesupport_category')->info('servicesupport Category Created : ------> ', ['200' , $results->toArray() ] );
            ...
            foreach ($input['question_no_'] as $key => $value) {
                ...
                log::channel('servicesupport_category')->info('servicesupport Category Created : ------> ', ['200' , $question_results->toArray() ] );
            }
            ...
            log::channel('servicesupport_category')->info('servicesupport Category Updated : ------> ', ['200' , $results_update->toArray() ] );

            DB::commit();

             //print_pre([$results , $totals] , true);
            return redirect('service_support_results');
