...
class adLDAPVendor
{
     ...
     * @var string
     */
    protected $_account_suffix = "@vendor.zuku.co.ke";
     ...
     * @var string
     */
    protected $_base_dn = "DC=vendor,DC=zuku,DC=co,DC=ke";
    ...
    protected $_domain_controllers = array("62.8.88.27");
    ...
    protected $_ad_password = "Zuku@9090";
